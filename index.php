        ...
        <main class="posts-listing col-lg-8"> 
            <div class="container">
                <div class="row" id="myTable">
                    ...
                    $statement = "`blogs` ORDER BY `id` desc"; // Change `records` according to your table name.
                    ...
                    while ($row = mysqli_fetch_array($results)) {
                        ...
                        <div class="post col-xl-6">
                           ...
                           <div class="post-thumbnail"><a href="post.php?id=<?php echo $row["id"]; ?>" style="width: 100%;"><img src="<?php echo $row["image"]; ?>" style="max-height: 200px; width: 100%;" alt="..."></a></div>
