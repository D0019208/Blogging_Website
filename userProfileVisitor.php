...
$results = mysqli_query($conDB,"SELECT * FROM blogs WHERE userId = '$id'  ORDER BY 'id' desc LIMIT {$startpoint} , {$per_page}");

while ($row = mysqli_fetch_array($results)) {
                            $query4 = "SELECT tag FROM blogs";
    ...
    ?>  
                        ...
                        <div class="post col-xl-6" style="background-color: white;">
                            ...
                            <div class="post-thumbnail"><a href="post.php?id=<?php echo $row["id"]; ?>" style="width: 100%;"><img src="<?php echo $row["image"]; ?>" style="max-height: 200px;" alt="..." class="img-fluid"></a></div>
                            <div class="post-details" style="text-align: left !important;">
                                ...
                                <footer class="post-footer d-flex align-items-center"><a href="#" class="author d-flex align-items-center flex-wrap">
                                        <div class="avatar"><div class="avatar"><img src="<?php echo $row["uploaderImage"] ?>" alt="..." style="width: 100%; height: 100%; border-radius: 50%;"></div></div>
