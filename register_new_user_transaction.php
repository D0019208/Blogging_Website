...
$response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6LcRJHUUAAAAAHK0QQWtka8rqlcVUxd3faFjbG96&response=".$_POST['g-recaptcha-response']."&remoteip=".$_SERVER['REMOTE_ADDR']);
$obj = json_decode($response);
if($obj->success == true)
{
    
    $newURL = "confirm_registration.php?token=" . $token;
